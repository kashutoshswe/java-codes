...
class bus extends JFrame implements ActionListener
{
  ...
  bus(){
    ...
    /*heading*/
      ...
      JLabel select= new JLabel("<html><b><font face=\"Helvetica\">"+"<br>"+"Book Bus Ticket Across India"+"<br><br>"+"</font></b></html>");
      ...
      ImageIcon packageIcon = new ImageIcon(new ImageIcon("/home/ashu/Desktop/Programming/Java/Project/Images/1.jpg").getImage().getScaledInstance(1366, 450, Image.SCALE_DEFAULT));
  ...
  public void actionPerformed(ActionEvent ae)
  {
    ...
    if(ae.getSource()==submit)
    {
      ...
      else
      {
        ...
        if(text2.getText().equals("") || (!(date2.matches("([0-9])"))))
        {
              ...
              if(checkFormat)
                {
                  ...
                  value=obj.insertbusdetails(date2,date,source,destination);
                  if(value)
                  {
